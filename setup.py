...
setup(
    ...
    url='https://github.com/datopian/ckanext-asset-storage',
    ...
    keywords='''CKAN asset storage cloud images IUploader''',
    ...
    entry_points='''
        [ckan.plugins]
        asset_storage=ckanext.asset_storage.plugin:AssetStoragePlugin
